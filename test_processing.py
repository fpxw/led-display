...
erode = ProcessingVariables.erode                  # 腐蚀核
threshold = ProcessingVariables.threshold          # 阈值
adjustment = ProcessingVariables.adjustment        # 调整
iterations = ProcessingVariables.iterations        # 迭代次数
blur = ProcessingVariables.blur                    # 模糊核
